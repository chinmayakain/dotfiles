local current_theme = require("helper.theme").theme
return {
  ...
  config = function()
    ...
    local env_var_nvim_theme = "onedark" or current_theme -- swap this to use current theme's colorschem for lualine
