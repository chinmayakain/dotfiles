return {
  -- NOTE: Rose-pine
  {
    "rose-pine/neovim", -- The correct repository for the plugin
    ...
    config = function()
      ...
      require("tokyonight").setup({
        ...
        on_colors = function(c)
          c.bg = is_transparent and c.none or colors.bg
          c.bg_dark = is_transparent and c.none or colors.bg_dark
          c.bg_float = is_transparent and c.none or colors.bg_dark
          c.bg_highlight = colors.bg_highlight
          c.bg_popup = colors.bg_dark
          c.bg_search = colors.bg_search
          c.bg_sidebar = is_transparent and c.none or colors.bg_dark
          c.bg_statusline = is_transparent and c.none or colors.bg_dark
      ...
      -- Auto switch to TokyoNight for Markdown files only
      vim.api.nvim_create_autocmd("FileType", {
        pattern = { "markdown" },
        callback = function()
          local buffer = vim.api.nvim_get_current_buf()
          if not vim.b[buffer].tokyonight_applied then
            if vim.fn.expand("%:t") ~= "" and vim.bo.buftype ~= "nofile" then
              vim.cmd("colorscheme tokyonight")
            end
