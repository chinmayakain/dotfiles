...
---@class helper.util.workspace.pnpm.PackageMeta
---@field name string|nil

---@class helper.util.workspace.pnpm.PackageInfo
---@field path Path
---@field name string|nil
---@field root boolean
...
---@class helper.util.workspace.pnpm.GetPackageInfoOpts
---@field root? string|Path
---@field focused_path? string|Path
---@field only_cached? boolean

---@class helper.util.workspace.pnpm.WorkspaceInfo
---@field root helper.util.workspace.pnpm.PackageInfo|nil @the root package
---@field focused helper.util.workspace.pnpm.PackageInfo|nil @the focused package
---@field packages helper.util.workspace.pnpm.PackageInfo[] @all packages
...
local cache = {
  ...
  workspaces = {},
  ---@type table<string, helper.util.workspace.pnpm.PackageMeta>
  package_meta = {},
}
...
--@param path Path
--@param opts? {only_cached?: boolean}
--@return helper.util.workspace.pnpm.PackageMeta|nil
local function get_package_meta(path, opts)
  ...
  --@type boolean, helper.util.workspace.pnpm.PackageMeta|nil
...
--@param opts? helper.util.workspace.pnpm.GetPackageInfoOpts
--@return helper.util.workspace.pnpm.PackageInfo|nil
...
--@return helper.util.workspace.pnpm.WorkspaceInfo|nil|false
