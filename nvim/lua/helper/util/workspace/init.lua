...
local cargo = require("helper.util.workspace.cargo")
local pnpm = require("helper.util.workspace.pnpm")

-- @alias helper.util.workspace.WorkspaceType "pnpm"|"cargo"

-- @alias helper.util.workspace.WorkspaceInfo helper.util.workspace.pnpm.WorkspaceInfo|helper.util.workspace.cargo.WorkspaceInfo

-- @class helper.util.workspace.GetWorkspaceInfoOpts
--@field workspace_type? helper.util.workspace.WorkspaceType
...
--@class helper.util.workspace.GetWorkspacePackagePathsOpts
--@field workspace_type? helper.util.workspace.WorkspaceType
--@field only_cached? boolean @whether to only use cached data
...
--@param root_dir? Path
--@return helper.util.workspace.WorkspaceType?
...
--@return helper.util.workspace.WorkspaceInfo|nil|false
...
--@param opts? {only_cached?: boolean, workspace_type?: helper.util.workspace.WorkspaceType}
