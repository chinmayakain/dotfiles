...
local Path = require("helper.util.path") ---@module 'plenary.path'
local util = require("helper.util.workspace.util")

---@class helper.util.workspace.cargo.PackageMeta
---@field id string
---@field name string|nil
---@field version string|nil
---@field manifest_path string|nil

---@class helper.util.workspace.cargo.WorkspaceMeta
---@field packages helper.util.workspace.cargo.PackageMeta[]
---@field workspace_members string[]
---@field workspace_root string

---@class helper.util.workspace.cargo.PackageInfo
---@field path Path
---@field name string|nil
---@field root boolean
...
---@class helper.util.workspace.cargo.GetPackageInfoOpts
---@field root? string|Path
---@field focused_path? string|Path
---@field only_cached? boolean

---@class helper.util.workspace.cargo.WorkspaceInfo
---@field root helper.util.workspace.cargo.PackageInfo|nil @the root package
---@field focused helper.util.workspace.cargo.PackageInfo|nil @the focused package
---@field packages helper.util.workspace.cargo.PackageInfo[] @all packages

---@class helper.util.workspace.cargo.GetWorkspaceMetadataOpts
---@field only_cached? boolean @whether to only use cached data
---@field callback? fun(paths: helper.util.workspace.cargo.WorkspaceMeta|nil) @the callback to call when the paths are found (get_workspace_package_paths will run asynchronously)
...
local cache = {
  ...
  roots = {},
  ---@type table<string, helper.util.workspace.cargo.WorkspaceMeta>
  workspaces = {},
}
...
---@param root_dir Path
---@param opts? helper.util.workspace.cargo.GetWorkspaceMetadataOpts
---@return helper.util.workspace.cargo.WorkspaceMeta|nil
...
---@param meta helper.util.workspace.cargo.WorkspaceMeta
---@return Path[]
local function get_workspace_package_paths(meta)
  local paths = {}
  ---@type table<string, helper.util.workspace.cargo.PackageMeta>
...
---otherwise it will block until the result is available and return it.
---@param root_dir? Path
--@param opts? helper.util.workspace.GetWorkspacePackagePathsOpts
---@return Path[]|nil
  ...
  if opts.callback then
    return M.get_workspace_metadata(root_dir, {
      ...
      callback = function(data)
        opts.callback(data and get_workspace_package_paths(data) or nil)
      end,
    })
  end
...
---@param ws_path Path
---@param opts? {only_cached?: boolean}
---@return helper.util.workspace.cargo.PackageMeta?
local function get_package_meta(root_path, ws_path, opts)
  ...
  ---@type helper.util.workspace.cargo.WorkspaceMeta?
...
---@param opts? helper.util.workspace.cargo.GetPackageInfoOpts
---@return helper.util.workspace.cargo.PackageInfo|nil
...
--@param opts? helper.util.workspace.GetWorkspaceInfoOpts
--@return helper.util.workspace.cargo.WorkspaceInfo|nil|false
